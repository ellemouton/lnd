...
// graphSourceChannelGraph wraps a GraphSource instance with the necessary API
// to properly implement the autopilot.ChannelGraph interface.
//
...
var _ ChannelGraph = (*graphSourceChannelGraph)(nil)
