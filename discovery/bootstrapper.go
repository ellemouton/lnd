...
func (c *ChannelGraphBootstrapper) SampleNodeAddrs(ctx context.Context, numAddrs uint32,
	ignore map[autopilot.NodeID]struct{}) ([]*lnwire.NetAddress, error) {
...
func (d *DNSSeedBootstrapper) SampleNodeAddrs(ctx context.Context, numAddrs uint32,
	ignore map[autopilot.NodeID]struct{}) ([]*lnwire.NetAddress, error) {
