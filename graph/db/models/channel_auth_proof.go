...
func (c *ChannelAuthProof) isChanAuthProof() {}

// ChanAuthProof is an interface that describes the proof of ownership of
// a channel.
type ChanAuthProof interface {
	// isChanAuthProof is a no-op method used to ensure that a struct must
...
var _ ChanAuthProof = (*ChannelAuthProof2)(nil)
