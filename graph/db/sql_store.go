...
type SQLQueries interface {
	...
	*/
	...
	ListChannelsPaginated(ctx context.Context, arg sqlc.ListChannelsPaginatedParams) ([]sqlc.Channel, error)
...
func (s *SQLStore) ChannelView() ([]EdgePoint, error) {
	...
	handleChannel := func(db SQLQueries, channel sqlc.Channel) error {
