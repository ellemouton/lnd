...
// TestPreferHighestAndGetVersions tests FetchChannelEdgesByIDPreferHighest,
// FetchChannelEdgesByOutpointPreferHighest, GetVersionsBySCID, and
// GetVersionsByOutpoint on the ChannelGraph.
