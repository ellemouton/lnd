...
func TestMuxForEachNodeChannel(t *testing.T) {
	...
	t.Run("self node", func(t *testing.T) {
		...
		kit.local.On(
			...
			cb := args.Get(2).(func(info *models.ChannelEdgeInfo,
				policy *models.ChannelEdgePolicy,
				policy2 *models.ChannelEdgePolicy) error) //nolint:forcetypeassert
...
func TestMuxForEachChannel(t *testing.T) {
	...
	t.Run("local and remote node have local channel", func(t *testing.T) {
		...
		kit.remote.On(
			...
			cb := args.Get(1).(func(info *models.ChannelEdgeInfo,
				_, _ *models.ChannelEdgePolicy) error) //nolint:forcetypeassert
...
func TestMuxForEachNodeDirectedChannel(t *testing.T) {
	...
	t.Run("local node", func(t *testing.T) {
		...
		kit.local.On(
			...
			cb := args.Get(3).(func(*graphdb.DirectedChannel) error) //nolint:forcetypeassert
...
func TestMuxForEachNode(t *testing.T) {
	...
	kit.local.On(
		...
		cb := args.Get(1).(func(*models.LightningNode) error) //nolint:forcetypeassert
	...
	kit.remote.On(
		...
		cb := args.Get(1).(func(*models.LightningNode) error) //nolint:forcetypeassertA
