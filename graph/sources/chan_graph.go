...
// channel graph within the network. The excludeNodes and excludeChannels
// parameters can be used to exclude nodes and channels from the stats.
//
// NOTE: this is part of the lnd.GraphSource interface.
func (s *ChanGraphSource) NetworkStats(_ context.Context,
...
//
// NOTE: this is part of the lnd.GraphSource interface.
func (s *ChanGraphSource) BetweennessCentrality(_ context.Context) (
