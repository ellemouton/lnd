...
func (q *Queries) DeleteZombieChannel(ctx context.Context, arg DeleteZombieChannelParams) error {
	_, err := q.db.ExecContext(ctx, deleteZombieChannel, arg.ChannelID, arg.Version)
	return err
}

const getChannelByChannelIDAndVersion = `-- name: GetChannelByChannelIDAndVersion :one
SELECT id, version, channel_id, node_id_1, node_id_2, outpoint, capacity FROM channels
WHERE channel_id = $1 AND version = $2
`

type GetChannelByChannelIDAndVersionParams struct {
	ChannelID []byte
	Version   int16
}

func (q *Queries) GetChannelByChannelIDAndVersion(ctx context.Context, arg GetChannelByChannelIDAndVersionParams) (Channel, error) {
	row := q.db.QueryRowContext(ctx, getChannelByChannelIDAndVersion, arg.ChannelID, arg.Version)
	var i Channel
	err := row.Scan(
		&i.ID,
		&i.Version,
...
const getChannelIDByOutpoint = `-- name: GetChannelIDByOutpoint :one
SELECT channel_id from channels
WHERE outpoint = $1 AND version = $2
`

type GetChannelIDByOutpointParams struct {
	Outpoint string
	Version  int16
}

func (q *Queries) GetChannelIDByOutpoint(ctx context.Context, arg GetChannelIDByOutpointParams) ([]byte, error) {
	row := q.db.QueryRowContext(ctx, getChannelIDByOutpoint, arg.Outpoint, arg.Version)
	var channel_id []byte
	err := row.Scan(&channel_id)
	return channel_id, err
}

const getChannelsByChannelIDRange = `-- name: GetChannelsByChannelIDRange :many
SELECT id, version, channel_id, node_id_1, node_id_2, outpoint, capacity
FROM channels
WHERE channel_id >= $1
  AND channel_id < $2
`

type GetChannelsByChannelIDRangeParams struct {
	StartChannelID []byte
	EndChannelID   []byte
}

func (q *Queries) GetChannelsByChannelIDRange(ctx context.Context, arg GetChannelsByChannelIDRangeParams) ([]Channel, error) {
	rows, err := q.db.QueryContext(ctx, getChannelsByChannelIDRange, arg.StartChannelID, arg.EndChannelID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
const getPublicV1ChannelsByChannelID = `-- name: GetPublicV1ChannelsByChannelID :many
SELECT c.id, c.version, c.channel_id, c.node_id_1, c.node_id_2, c.outpoint, c.capacity
FROM channels c
...
type GetPublicV1ChannelsByChannelIDParams struct {
	StartChannelID []byte
	EndChannelID   []byte
}

func (q *Queries) GetPublicV1ChannelsByChannelID(ctx context.Context, arg GetPublicV1ChannelsByChannelIDParams) ([]Channel, error) {
	rows, err := q.db.QueryContext(ctx, getPublicV1ChannelsByChannelID, arg.StartChannelID, arg.EndChannelID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT DISTINCT c.id, c.version, c.channel_id, c.node_id_1, c.node_id_2, c.outpoint, c.capacity
FROM channels c
...
const getV1DisabledChannelIDs = `-- name: GetV1DisabledChannelIDs :many
SELECT c.channel_id
FROM channels c
         JOIN channel_policies cp ON cp.channel_id = c.id
         JOIN channel_policy_v1_data v1 ON v1.channel_policy_id = cp.id
...
func (q *Queries) GetV1DisabledChannelIDs(ctx context.Context) ([][]byte, error) {
	rows, err := q.db.QueryContext(ctx, getV1DisabledChannelIDs)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT channel_id, version, node_key_1, node_key_2
FROM zombie_channels
WHERE channel_id = $1
AND version = $2
`
...
func (q *Queries) GetZombieChannel(ctx context.Context, arg GetZombieChannelParams) (ZombieChannel, error) {
	row := q.db.QueryRowContext(ctx, getZombieChannel, arg.ChannelID, arg.Version)
	var i ZombieChannel
	err := row.Scan(
		&i.ChannelID,
		&i.Version,
...
const highestChannelID = `-- name: HighestChannelID :one
SELECT channel_id
FROM channels
WHERE version = $1
...
func (q *Queries) HighestChannelID(ctx context.Context, version int16) ([]byte, error) {
	row := q.db.QueryRowContext(ctx, highestChannelID, version)
	var channel_id []byte
	err := row.Scan(&channel_id)
	return channel_id, err
}
...
func (q *Queries) InsertClosedChannel(ctx context.Context, channelID []byte) error {
	_, err := q.db.ExecContext(ctx, insertClosedChannel, channelID)
	return err
}
...
func (q *Queries) IsClosedChannel(ctx context.Context, channelID []byte) (bool, error) {
	row := q.db.QueryRowContext(ctx, isClosedChannel, channelID)
	var exists bool
	err := row.Scan(&exists)
	return exists, err
}
...
func (q *Queries) IsZombieChannel(ctx context.Context, arg IsZombieChannelParams) (bool, error) {
	row := q.db.QueryRowContext(ctx, isZombieChannel, arg.ChannelID, arg.Version)
	var is_zombie bool
