...
type Querier interface {
	...
	GetChannelBySCID(ctx context.Context, arg GetChannelBySCIDParams) (GetChannelBySCIDRow, error)
	...
	GetChannelView(ctx context.Context, version int16) ([]GetChannelViewRow, error)
	...
	ListAllChannels(ctx context.Context, version int16) ([]ListAllChannelsRow, error)
	...
	ListNodes(ctx context.Context, version int16) ([]ListNodesRow, error)
