...
type GraphProvider interface {
	// GetGraphSource returns the GraphSource that LND will use for
	// read-only graph related queries.
	GetGraphSource(context.Context, *DatabaseInstances) (
		sources.GraphSource, error)
}
...
// GetGraphSource returns the GraphSource that LND will use for read-only graph
// related queries. By default, the GraphSource implementation is this LND
// node's backing graphdb.ChannelGraph.
//
// NOTE: this is part of the GraphProvider interface.
func (d *DefaultWalletImpl) GetGraphSource(_ context.Context,
