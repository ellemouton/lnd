...
func (f *mockChannelLink) CheckHtlcForward(context.Context, [32]byte,
	...
	models.InboundFee, uint32,
	lnwire.ShortChannelID, lnwire.CustomRecords) *LinkError {

	return f.checkHtlcForwardResult
}

func (f *mockChannelLink) CheckHtlcTransit(ctx context.Context,
	payHash [32]byte,
...
func (f *mockChannelLink) attachFailAliasUpdate(closure func(ctx context.Context,
