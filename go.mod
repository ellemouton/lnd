...
replace (
	github.com/btcsuite/btcwallet => github.com/ellemouton/btcwallet v0.11.1-0.20230517182024-b0276a247423
	github.com/lightninglabs/neutrino => github.com/ellemouton/neutrino v0.11.1-0.20230512140100-ba7a6a96107a
)
