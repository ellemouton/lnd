...
type RouterBackend struct {
	...
	FetchAmountPairCapacity func(ctx context.Context, nodeFrom,
		nodeTo route.Vertex, amount lnwire.MilliSatoshi) (
		btcutil.Amount, error)

	// FetchChannelEndpoints returns the pubkeys of both endpoints of the
	// given channel id.
	FetchChannelEndpoints func(ctx context.Context, chanID uint64) (
...
func (r *RouterBackend) parseIgnored(ctx context.Context,
	in *lnrpc.QueryRoutesRequest) (map[route.Vertex]struct{},
	map[routing.DirectedNodePair]struct{}, error) {
...
func (r *RouterBackend) MarshallRoute(ctx context.Context, route *route.Route) (
	*lnrpc.Route, error) {
