...
// backups.
func (c *WatchtowerClient) AddTower(_ context.Context,
	...
	if err != nil {
		return nil, fmt.Errorf("invalid address %v: %v", req.Address,
			err)
	}
...
func (c *WatchtowerClient) ListTowers(ctx context.Context,
	...
	towersPerBlobType, err := c.cfg.Client.RegisteredTowers(opts...)
	if err != nil {
		return nil, err
	}
...
func (c *WatchtowerClient) GetTowerInfo(ctx context.Context,
	...
	towersPerBlobType, err := c.cfg.Client.LookupTower(pubKey, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *WatchtowerClient) Policy(ctx context.Context,
	...
	policy, err := c.cfg.Client.Policy(blobType)
	if err != nil {
		return nil, err
	}
