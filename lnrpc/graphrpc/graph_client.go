...
// Client is a wrapper that implements the lnd.GraphSource interface using a
...
// to implement the lnd.GraphSource interface.
func NewRemoteClient(conn *grpc.ClientConn, net tor.Net) *Client {
	return &Client{
...
//
// NOTE: This is a part of the lnd.GraphSource interface.
...
// current state of the known channel graph within the network. The
// excludeNodes and excludeChannels parameters can be used to exclude nodes and
// channels from the stats.
//
// NOTE: this is part of the lnd.GraphSource interface.
func (r *Client) NetworkStats(ctx context.Context,
...
//
// NOTE: this is part of the lnd.GraphSource interface.
func (r *Client) NewPathFindTx(_ context.Context) (graphsession.RTx, error) {
...
//
// NOTE: this is part of the lnd.GraphSource interface.
func (r *Client) ForEachNodeDirectedChannel(ctx context.Context,
	_ graphsession.RTx, node route.Vertex,
...
// in question. If no features are known for the node, an empty feature vector
// is returned.
//
// NOTE: The read transaction passed in is ignored.
//
// NOTE: this is part of the lnd.GraphSource interface.
func (r *Client) FetchNodeFeatures(ctx context.Context, _ graphsession.RTx,
...
// yet been received for the channel.
//
// NOTE: this is an expensive call as it fetches all nodes from the network and
// so it is recommended that caching be used by both the client and the server
// where appropriate to reduce the number of calls to this method.
...
// are passed into the callback as nil values.
//
// NOTE: this is part of the lnd.GraphSource interface.
...
// and most recent channel edge policies for a given outpoint.
//
// NOTE: this is part of the lnd.GraphSource interface.
...
var _ graphsession.RTx = (*rpcRTx)(nil)
...
func (r *Client) unmarshalAddrs(addrs []*lnrpc.NodeAddress) ([]net.Addr, error) {
