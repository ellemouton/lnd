...
type BuildBlindedPathCfg struct {
	...
	FetchChannelEdgesByID func(ctx context.Context, chanID uint64) (*models.ChannelEdgeInfo,
...
func getNodeChannelPolicy(cfg *BuildBlindedPathCfg, chanID uint64,
	...
	_, update1, update2, err := cfg.FetchChannelEdgesByID(context.TODO(), chanID)
	if err != nil {
		return nil, err
	}
