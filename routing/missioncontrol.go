...
// MissionControlManager manages MissionControl instances in various namespaces.
//
...
// NewMissionControlMgr returns a new instance of MissionControlManager.
func NewMissionControlMgr(db kvdb.Backend, self route.Vertex,
	cfg *MissionControlConfig) (*MissionControlManager, error) {
...
// clear can be used to reset the contents of the store's bucket.
//
// NOTE: this is part of the missionControlDB interface.
func (n *namespacedDB) clear() error {
	return n.db.Update(func(tx kvdb.RwTx) error {
