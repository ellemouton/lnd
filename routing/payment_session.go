...
type PaymentSession interface {
	...
	// error.
	UpdateAdditionalEdge(msg lnwire.ChanUpdate, pubKey *btcec.PublicKey,
...
func (p *paymentSession) UpdateAdditionalEdge(msg lnwire.ChanUpdate,
	...
	policy.TimeLockDelta = msg.GetTimeLock()
	policy.FeeBaseMSat = msg.GetBaseFee()
	policy.FeeProportionalMillionths = msg.GetFeeRate()
