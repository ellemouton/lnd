...
// findBlindedPaths does a depth first search from the target node to find
// a set of blinded paths to the target node given the set of restrictions.
// This function will select and return any candidate path. The logic for
// filtering out paths based on payment value and mission control data is left
