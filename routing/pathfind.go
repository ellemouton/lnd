...
func getOutgoingBalance(node route.Vertex, outgoingChans map[uint64]struct{},
	...
	err := g.ForEachNodeChannel(context.TODO(), node, cb)
	if err != nil {
		return 0, 0, err
	}
...
func findPath(g *graphParams, r *RestrictParams, cfg *PathFindingConfig,
	...
	if features == nil {
		var err error
		features, err = g.graph.FetchNodeFeatures(context.TODO(), target)
		if err != nil {
			return nil, 0, err
		}
	}
	...
	getGraphFeatures := func(node route.Vertex) (*lnwire.FeatureVector,
		...
		fromFeatures, err := g.graph.FetchNodeFeatures(context.TODO(), node)
		if err != nil {
			return nil, err
		}
...
func processNodeForBlindedPath(g Graph, node route.Vertex,
	...
	err = g.ForEachNodeChannel(context.TODO(), node,
