...
// left to the caller.
func findBlindedPaths(ctx context.Context, g graphdb.RoutingGraph,
	target route.Vertex, restrictions *blindedPathRestrictions) (
	[][]blindedHop, error) {
...
// node.
func processNodeForBlindedPath(ctx context.Context, g graphdb.RoutingGraph,
	node route.Vertex,
