...
// NewPathFindTx returns a new read transaction that can be used other read calls to
// the backing graph.
//
// NOTE: this is part of the graphsession.ReadOnlyGraph interface.
func (g *GraphSourceMux) NewPathFindTx(ctx context.Context) (graphdb.RTx, error) {
