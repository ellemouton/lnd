...
type Config struct {
	...
	// SQLiteCmdReplacements define a one-to-one string mapping of sql keywords
	// to the strings that should replace those keywords in any commands.
...
var (
	// dbComms is a global set of database connections.
	dbConns   *dbConnSet
