...
func SetupLoggers(root *build.SubLoggerManager, interceptor signal.Interceptor) {
	...
	for _, l := range lndPkgLoggers {
		...
		SetSubV1Logger(root, l.subsystem, l.Logger)
	}
...
func AddV1SubLogger(root *build.SubLoggerManager, subsystem string,
	...
	SetSubV1Logger(root, subsystem, logger, useLoggers...)
}
...
// SetSubV1Logger is a helper method to conveniently register the logger of a sub
// system.
func SetSubV1Logger(root *build.SubLoggerManager, subsystem string,
