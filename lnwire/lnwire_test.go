...
var (
	...
	testSchnorrSigStr, _ = hex.DecodeString("04E7F9037658A92AFEB4F25BAE5339E3DDCA81A353493827D26F16D92308E49E2A25E92208678A2DF86970DA91B03A8AF8815A8A60498B358DAF560B347AA557")
...
func TestLightningWireProtocol(t *testing.T) {
	...
	customTypeGen := map[MessageType]func([]reflect.Value, *rand.Rand){
		...
		MsgChannelUpdate2: func(v []reflect.Value, r *rand.Rand) {
			...
			req.FeeProportionalMillionths = defaultFeeProportionalMillionths
			if r.Int31()%2 == 0 {
