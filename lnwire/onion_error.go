...
func parseChannelUpdateCompatibilityMode(reader io.Reader, length uint16,
	...
	default:
		...
		// in the spec. This should only be the case for the
		// ChannelUpdate1 message.
		chanUpdate = &ChannelUpdate1{}
	}
	...
	// At this point, we've either decided to keep the entire thing, or
	// snip off the first two bytes. In either case, we can just read it as
	// normal.
