...
func NewTemporaryChannelFailure(update *ChannelUpdate1) *FailTemporaryChannelFailure {
...
func NewChannelDisabled(flags uint16, update ChannelUpdate1) *FailChannelDisabled {
...
// writeOnionErrorChanUpdate writes out a ChannelUpdate1 using the onion error
