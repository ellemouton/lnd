...
func createEdge(height, txIndex uint32, txPosition uint16, outPointIndex uint32,
	node1, node2 *LightningNode) (*models.ChannelEdgeInfo1, lnwire.ShortChannelID) {
...
func assertEdgeInfoEqual(t *testing.T, e1, e2 models.ChannelEdgeInfo) {
	...
	case *models.ChannelEdgeInfo2:
		edge2, ok := e2.(*models.ChannelEdgeInfo2)
		require.True(t, ok)
...
func assertEdgeInfo2Equal(t *testing.T, e1, e2 *models.ChannelEdgeInfo2) {
...
func createChannelEdge(db kvdb.Backend, node1, node2 *LightningNode) (*models.ChannelEdgeInfo1,
...
func createEdge2(height, txIndex uint32, txPosition uint16,
	outPointIndex uint32, node1, node2 *LightningNode) (
	*models.ChannelEdgeInfo2, lnwire.ShortChannelID) {
...
func assertEdgeWithPolicyInCache(t *testing.T, g *ChannelGraph,
	e *models.ChannelEdgeInfo1, p *models.ChannelEdgePolicy1, policy1 bool) {
...
func TestNodeIsPublic(t *testing.T) {
	...
	edges := []*models.ChannelEdgeInfo1{aliceBobEdge, bobCarolEdge}
			...
			for _, n := range nodes {
				err := n.ForEachChannel(
					tx, func(tx kvdb.RTx,
						...
						maxHTLCs += policy.ForwardingPolicy().MaxHTLC
						maxHTLCs += policy2.ForwardingPolicy().MaxHTLC
